<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = '../../../../userfiles/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../../userfiles/'; // absolute or relative from this script path, required.
