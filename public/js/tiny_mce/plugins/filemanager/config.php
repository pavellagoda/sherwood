<?php
        ...
        $mcFileManagerConfig['filesystem.path'] = '../../../../userfiles/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = '../../../../userfiles/'; // absolute or relative from this script path.
