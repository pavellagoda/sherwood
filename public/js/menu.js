...
arrowimages: {down:['downarrowclass', '/i/down.gif', 23], right:['rightarrowclass', '/i/right.gif']},
...
init:function(setting){
	...
	$('document').ready(function($){ //override default menu colors (default/hover) with custom set?
