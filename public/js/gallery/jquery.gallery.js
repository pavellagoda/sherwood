...
//            })
//            
//            $('a.dg-right').live('click', function(){
//                _self._navigate('next');
//                return false;
//            })
//            
//            $('a.dg-left').live('click', function(){
//                _self._navigate('prev');
//                return false;
//            })
            
            this.$nextItm.on( 'click.gallery', function( event ) {
                _self._navigate('next');
                return false;
            })
            ...
            this.$wrapper.on( 'webkitTransitionEnd.gallery transitionend.gallery OTransitionEnd.gallery', function( event ) {
                ...
                _self.$items.removeClass('dg-left');
                _self.$items.removeClass('dg-right');
                
                _self.$rightItm.addClass('dg-right');
                _self.$leftItm.addClass('dg-left');
