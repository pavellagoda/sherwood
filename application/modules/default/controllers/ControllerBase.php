...
class modules_default_controllers_ControllerBase extends controllers_ControllerBase
{
    ...
    public function init()
    {
        ...
        $this->view->headLink()->headLink(array('rel' => 'shortcut icon', 'href' => '/favicon.ico?rand=' . rand(1, 100000), 'type' => 'image/x-icon'), 'APPEND');
        ...
        $this->view->trans = Zend_Registry::get('Zend_Translate');
//        echo($this->view->trans->translate('name', 'ua')); die;
    }
