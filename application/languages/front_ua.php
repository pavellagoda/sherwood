...
return array (
    ...
    Zend_Validate_EmailAddress::INVALID_FORMAT => '"%value%" невірна адреса електронной пошты. Введіть его у форматі ім`я@домен',
    Zend_Validate_EmailAddress::INVALID_HOSTNAME => '"%hostname%" невірный домен для адреси "%value%"',
    Zend_Validate_EmailAddress::INVALID_MX_RECORD => 'Домен "%hostname%" не має MX-запису про адресу "%value%"',
    Zend_Validate_EmailAddress::DOT_ATOM => '"%localPart%" не відповідає формату dot-atom',
    Zend_Validate_EmailAddress::QUOTED_STRING => '"%localPart%" не відповідає формату вказанної строки',
    Zend_Validate_EmailAddress::INVALID_LOCAL_PART => '"%localPart%" не вірне ім`я для адреси "%value%", вводіть адресу вгляду ім`я@домен',
    ...
    Zend_Validate_NotEmpty::IS_EMPTY => 'Введене значення пусте, заповніть поле, будь ласка',
    ...
    Zend_Captcha_Image::BAD_CAPTCHA => 'Введені символи невірні',
    FW_EqualInputs::NOT_EQUAL => 'Введенные значения не равны',
    'name' => 'Ім`я',
);